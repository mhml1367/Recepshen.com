...
class flightController extends Controller
{
    ...
    {
        $ch = curl_init('http://recepshen.ir/api/flights/reserve');
        curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode(array(
            'agentPay' => "0",
            'redirectPath' => "http://recepshen.com/flight/reserve/confirmation",
            'user_token' => "DEsFVekRIkrvfbfiuULvzSdvLL6BwvkzGg0LRJDtySA7a0xsYladMyxJ2gcLv8LNt74ihjAxz9RvXE7bymLm8op47Oqqiur0",
            'token' => 'mzoc1CEq401565108119FTd7QvbGea',
            "flightData"=> array(
                    'FlightNumber'     => (int) $rec->input("FlightNumber"),
                    ...
                    'airline_name'      => $rec->input("airline_name"),
                ),
            "guests"=> array(
                "adults"=> array(
                    array(
    ...
    public function confirmation()
    {
        ...
        if (isset($factor) && isset($status)){
            ...
            $ch = curl_init('http://recepshen.ir/api/flight/reserves/confirmation');
            curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode(array(
        ...
        return view('flight/confirmation')->with(compact('rest'));
    }
